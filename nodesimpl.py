...
class NodeCall:
    ...
    def __init__(self, family, node, class_name, meth_name, self_name=None, out_name=None, ret_class=None, args_hooks={}, **variation):
        ...
        self.args = self.node.build_arguments(only_enabled=True, variation=variation, self_name=self.self_name, hooks=args_hooks)
    ...
    def node_creation(self):
        ...
        if self.family == 'ATTRIBUTE':
            ...
            snode = f"nodes.Node{self.node.node_name}({self.args.node_call})"
        ...
        if self.family == 'STACK':
            ...
            return f"{self.ret_class}({snode}.{self.out_name})"
...
class GeometryGen(DataClass):
    def __init__(self, nodes):
        ...
        #self.add_call('PROPERTY', 'GeometryNodeBoundBox',           'bound_box',        prop_names=('box', 'box_min', 'box_max'))
        #self.add_call('PROPERTY', 'GeometryNodeSeparateComponents', 'components',       
        #                  prop_names=('mesh_component', 'points_component', 'curve_component', 'volume_component', 'instances_component'))
...
class MeshGen(DataClass):
    def __init__(self, nodes):
        ...
        self.add_call('METHOD', 'GeometryNodeSplitEdges',         'split_edges',         stack=True)
        self.add_call('METHOD', 'GeometryNodeSubdivideMesh',      'subdivide',           stack=True)
        self.add_call('METHOD', 'GeometryNodeSubdivisionSurface', 'subdivision_surface', stack=True)
        self.add_call('METHOD', 'GeometryNodeTriangulate',        'triangulate',         stack=True)
        self.add_call('METHOD', 'GeometryNodeDualMesh',           'dual',                stack=True)
        self.add_call('METHOD', 'GeometryNodeExtrudeMesh',        'extrude',                       )
        self.add_call('METHOD', 'GeometryNodeFlipFaces',          'flip_faces',          stack=True)
...
class PointsGen(DataClass):
    def __init__(self, nodes):
        super().__init__(nodes, 'Points', 'Mesh')
        
        self.add_call('METHOD', 'GeometryNodeSetPointRadius',    'set_radius', stack=True)
...
class InstancesGen(DataClass):
    def __init__(self, nodes):
        super().__init__(nodes, 'Instances', 'Mesh')
        
        self.add_attribute('GeometryNodeInputIndex',      'index',     domains=['INSTANCE']  )
        
        self.add_call('METHOD', 'GeometryNodeRotateInstances',    'rotate',    stack=True)
        self.add_call('METHOD', 'GeometryNodeScaleInstances',     'scale',     stack=True)
        self.add_call('METHOD', 'GeometryNodeTranslateInstances', 'translate', stack=True)
...
class VolumeGen(DataClass):
    def __init__(self, nodes):
        super().__init__(nodes, 'Volume', 'Mesh')
...
class SplineGen(DataClass):
    def __init__(self, nodes):
        ...
        self.add_call('METHOD', 'GeometryNodeSetSplineCyclic',              'set_cyclic',     stack=True)
        self.add_call('METHOD', 'GeometryNodeSetSplineResolution',          'set_resolution', stack=True)
...
class CurveGen(DataClass):
    def __init__(self, nodes):
        ...
        self.add_call('CONSTRUCTOR', 'GeometryNodeCurveArc',                    'ArcFromRadius', variation={'mode':'RADIUS'})
        ...
        self.add_call('METHOD', 'GeometryNodeCurveSetHandles',          'set_handles',              stack=True)
        self.add_call('METHOD', 'GeometryNodeCurveSplineType',          'set_spline_type',          stack=True)
        self.add_call('METHOD', 'GeometryNodeFillCurve',                'fill',                     stack=True)
        self.add_call('METHOD', 'GeometryNodeFilletCurve',              'fillet',                   stack=True)
        self.add_call('METHOD', 'GeometryNodeResampleCurve',            'resample',                 stack=True)
        self.add_call('METHOD', 'GeometryNodeReverseCurve',             'reverse',                  stack=True)
        self.add_call('METHOD', 'GeometryNodeSetCurveHandlePositions',  'set_handle_positions',     stack=True)
        self.add_call('METHOD', 'GeometryNodeSetCurveRadius',           'set_radius',               stack=True)
        self.add_call('METHOD', 'GeometryNodeSetCurveTilt',             'set_tilt',                 stack=True)
        self.add_call('METHOD', 'GeometryNodeSubdivideCurve',           'subdivide',                stack=True)
        self.add_call('METHOD', 'GeometryNodeTrimCurve',                'trim',                     stack=True)
