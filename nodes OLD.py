...
class NodeGroup(Node):
    ...
    PARAMETERS = ['interface', 'node_tree']

    def __init__(self, interface=None, node_tree=None):
...
class NodeStringtoCurves(Node):
    ...
    PARAMETERS = ['align_x', 'align_y', 'font', 'overflow', 'pivot_mode']

    def __init__(self, string=None, size=None, character_spacing=None, word_spacing=None, line_spacing=None, text_box_width=None, text_box_height=None, align_x='LEFT', align_y='TOP_BASELINE', font=None, overflow='OVERFLOW', pivot_mode='BOTTOM_LEFT'):
...
class NodeFloatCurve(Node):
    ...
    def __init__(self, factor=None, value=None, mapping=None):
...
class NodeMath(Node):
    ...
    def __init__(self, value0=None, value1=None, value=None, operation='ADD', use_clamp=False):
...
class NodeRGBCurves(Node):
    ...
    def __init__(self, fac=None, color=None, mapping=None):
...
class NodeColorRamp(Node):
    ...
    PARAMETERS = ['color_ramp']

    def __init__(self, fac=None, color_ramp=None):
...
class NodeVectorCurves(Node):
    ...
    def __init__(self, fac=None, vector=None, mapping=None):
...
class NodeVectorMath(Node):
    ...
    def __init__(self, vector0=None, vector1=None, vector=None, scale=None, operation='ADD'):
