...
``` python
Closure(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
New [Closure](core-gener-closu-closure.md#closure) input with subtype 'NONE'.
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Closure](core-closure.md#closure) :black_small_square: [Content](core-closure.md#content) :black_small_square: [Methods](core-closure.md#methods)</sub>
