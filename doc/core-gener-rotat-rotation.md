...
``` python
Rotation(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- **A** : [AlignToVector](core-gener-rotat-rotation.md#aligntovector) :black_small_square: [align_to_vector](core-gener-rotat-rotation.md#align_to_vector) :black_small_square: [AlignXToVector](core-gener-rotat-rotation.md#alignxtovector) :black_small_square: [align_x_to_vector](core-gener-rotat-rotation.md#align_x_to_vector) :black_small_square: [AlignYToVector](core-gener-rotat-rotation.md#alignytovector) :black_small_square: [align_y_to_vector](core-gener-rotat-rotation.md#align_y_to_vector) :black_small_square: [AlignZToVector](core-gener-rotat-rotation.md#alignztovector) :black_small_square: [align_z_to_vector](core-gener-rotat-rotation.md#align_z_to_vector) :black_small_square: [axis_angle](core-gener-rotat-rotation.md#axis_angle)
- **C** : [\_create_input_socket](core-gener-rotat-rotation.md#_create_input_socket)
- **E** : [enable_output](core-gener-rotat-rotation.md#enable_output)
- **F** : [FromAxes](core-gener-rotat-rotation.md#fromaxes) :black_small_square: [FromAxisAngle](core-gener-rotat-rotation.md#fromaxisangle) :black_small_square: [FromEuler](core-gener-rotat-rotation.md#fromeuler) :black_small_square: [FromQuaternion](core-gener-rotat-rotation.md#fromquaternion) :black_small_square: [FromXYAxes](core-gener-rotat-rotation.md#fromxyaxes) :black_small_square: [FromXZAxes](core-gener-rotat-rotation.md#fromxzaxes) :black_small_square: [FromYXAxes](core-gener-rotat-rotation.md#fromyxaxes) :black_small_square: [FromYZAxes](core-gener-rotat-rotation.md#fromyzaxes) :black_small_square: [FromZXAxes](core-gener-rotat-rotation.md#fromzxaxes) :black_small_square: [FromZYAxes](core-gener-rotat-rotation.md#fromzyaxes)
- **H** : [hash_value](core-gener-rotat-rotation.md#hash_value)
- **I** : [invert](core-gener-rotat-rotation.md#invert)
- **M** : [mix](core-gener-rotat-rotation.md#mix)
- **N** : [Named](core-gener-rotat-rotation.md#named) :black_small_square: [NamedAttribute](core-gener-rotat-rotation.md#namedattribute)
- **R** : [rotate](core-gener-rotat-rotation.md#rotate) :black_small_square: [rotate_global](core-gener-rotat-rotation.md#rotate_global) :black_small_square: [rotate_local](core-gener-rotat-rotation.md#rotate_local) :black_small_square: [rotate_vector](core-gener-rotat-rotation.md#rotate_vector)
- **T** : [to_axis_angle](core-gener-rotat-rotation.md#to_axis_angle) :black_small_square: [to_euler](core-gener-rotat-rotation.md#to_euler) :black_small_square: [to_quaternion](core-gener-rotat-rotation.md#to_quaternion)
- **W** : [wxyz](core-gener-rotat-rotation.md#wxyz)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Rotation](core-gener-rotat-rotation.md#rotation) :black_small_square: [Content](core-gener-rotat-rotation.md#content) :black_small_square: [Properties](core-gener-rotat-rotation.md#properties)</sub>
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Rotation](core-gener-rotat-rotation.md#rotation) :black_small_square: [Content](core-gener-rotat-rotation.md#content) :black_small_square: [Methods](core-gener-rotat-rotation.md#methods)</sub>
...
New [Rotation](core-gener-rotat-rotation.md#rotation) input with subtype 'NONE'.
