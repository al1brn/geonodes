...
> domain is singular : [Instance](geono-instance.md#instance). The named of the domain property is [insts](macro-geono-instances.md#insts).
...
```
Nodes requiring a domain parameter, are implemented in the domain [insts](macro-geono-instances.md#insts).
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Instances](macro-geono-instances.md#instances) :black_small_square: [Content](macro-geono-instances.md#content) :black_small_square: [Properties](macro-geono-instances.md#properties)</sub>
