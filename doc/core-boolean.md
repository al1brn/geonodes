...
- **B** : [band](core-boolean.md#band) :black_small_square: [bnot](core-boolean.md#bnot) :black_small_square: [bor](core-boolean.md#bor)
- **C** : [clip_grid](core-boolean.md#clip_grid) :black_small_square: [\_create_input_socket](core-boolean.md#_create_input_socket) :black_small_square: [CubeGridTopology](core-boolean.md#cubegridtopology)
- **E** : [enable_output](core-boolean.md#enable_output) :black_small_square: [error](core-boolean.md#error)
- **F** : [field_to_grid](core-boolean.md#field_to_grid)
- **G** : [grid_dilate_erode](core-boolean.md#grid_dilate_erode) :black_small_square: [grid_info](core-boolean.md#grid_info) :black_small_square: [grid_to_points](core-boolean.md#grid_to_points)
- **I** : [imply](core-boolean.md#imply) :black_small_square: [info](core-boolean.md#info)
- **N** : [Named](core-boolean.md#named) :black_small_square: [NamedAttribute](core-boolean.md#namedattribute) :black_small_square: [nimply](core-boolean.md#nimply) :black_small_square: [nor](core-boolean.md#nor) :black_small_square: [not_and](core-boolean.md#not_and)
- **P** : [prune_grid](core-boolean.md#prune_grid)
- **R** : [Random](core-boolean.md#random)
- **S** : [sample_grid](core-boolean.md#sample_grid) :black_small_square: [sample_grid_index](core-boolean.md#sample_grid_index) :black_small_square: [set_grid_background](core-boolean.md#set_grid_background) :black_small_square: [set_grid_transform](core-boolean.md#set_grid_transform)
- **U** : [uv_unwrap](core-boolean.md#uv_unwrap)
- **V** : [voxel_index](core-boolean.md#voxel_index) :black_small_square: [voxelize_grid](core-boolean.md#voxelize_grid)
- **W** : [warning](core-boolean.md#warning)
- **X** : [xnor](core-boolean.md#xnor) :black_small_square: [xor](core-boolean.md#xor)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Boolean](core-boolean.md#boolean) :black_small_square: [Content](core-boolean.md#content) :black_small_square: [Methods](core-boolean.md#methods)</sub>
