...
> Node [Collection](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/input/constant/collection.html)

#### Arguments:
- **collection** (_NoneType_ = None) : parameter 'collection'
...
``` python
distribute_points_on_faces(mesh=None, selection=None, distance_min=None, density_max=None, density=None, density_factor=None, seed=None, distribute_method='RANDOM')
```
...
``` python
find_in_string(string=None, search=None)
```
...
#### Arguments:
- **matrix** (_Matrix_ = None) : socket 'Matrix' (id: Matrix)
...
``` python
menu_switch(menu=None, a=None, b=None, data_type='GEOMETRY')
```
...
> Node [Mouse Position](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/input/scene/mouse_position.html)
...
> Node [Object](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/input/constant/object.html)
...
``` python
random_value(min=None, max=None, min_1=None, max_1=None, min_2=None, max_2=None, probability=None, id=None, seed=None, data_type='FLOAT')
```
...
- **min_1** (_Float_ = None) : socket 'Min' (id: Min_001)
- **max_1** (_Float_ = None) : socket 'Max' (id: Max_001)
- **min_2** (_Integer_ = None) : socket 'Min' (id: Min_002)
- **max_2** (_Integer_ = None) : socket 'Max' (id: Max_002)
...
#### Arguments:
- **target_geometry** (_Geometry_ = None) : socket 'Target Geometry' (id: Target Geometry)
- **attribute** (_Float_ = None) : socket 'Attribute' (id: Attribute)
...
``` python
repeat_output(geometry=None, inspection_index=0)
```
...
``` python
resample_curve(curve=None, selection=None, count=None, length=None, keep_last_segment=True, mode='COUNT')
```
...
``` python
sample_curve(curves=None, value=None, length=None, curve_index=None, factor=None, data_type='FLOAT', mode='FACTOR', use_all_curves=False)
```
...
> Node [Selection](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/geometry/read/selection.html)
...
``` python
simulation_output(skip=None, geometry=None)
```

> Node ERROR: Node 'Simulation Output' not found

#### Arguments:
- **skip** (_Boolean_ = None) : socket 'Skip' (id: Skip)
- **geometry** (_Geometry_ = None) : socket 'Geometry' (id: Item_0)
...
``` python
subdivision_surface(mesh=None, level=None, edge_crease=None, vertex_crease=None, limit_surface=None, boundary_smooth='ALL', uv_smooth='PRESERVE_BOUNDARIES')
```
...
``` python
triangulate(mesh=None, selection=None, ngon_method='BEAUTY', quad_method='SHORTEST_DIAGONAL')
```
...
``` python
trim_curve(curve=None, selection=None, start=None, end=None, start_1=None, end_1=None, mode='FACTOR')
```
...
> Node [Viewport Transform](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/input/scene/viewport_transform.html)
...
#### Arguments:
- **show** (_Boolean_ = None) : socket 'Show' (id: Show)
