...
``` python
Object(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- [ActiveCamera](core-gener-objec-object.md#activecamera)
- [bone_info](core-gener-objec-object.md#bone_info)
- [camera_info](core-gener-objec-object.md#camera_info)
- [\_create_input_socket](core-gener-objec-object.md#_create_input_socket)
- [enable_output](core-gener-objec-object.md#enable_output)
- [info](core-gener-objec-object.md#info)
- [Self](core-gener-objec-object.md#self)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Object](core-gener-objec-object.md#object) :black_small_square: [Content](core-gener-objec-object.md#content) :black_small_square: [Methods](core-gener-objec-object.md#methods)</sub>
...
``` python
bone_info(bone_name: 'String' = None, transform_space: "Literal['ORIGINAL', 'RELATIVE']" = 'ORIGINAL')
```

> Node [Bone Info](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/input/scene/bone_info.html)
...
#### Arguments:
- **bone_name** (_String_ = None) : socket 'Bone Name' (id: Bone Name)
...
New [Object](core-gener-objec-object.md#object) input with subtype 'NONE'.
