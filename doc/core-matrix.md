...
- **A** : [as_tuple](core-matrix.md#as_tuple)
- **C** : [column_1_row_1](core-matrix.md#column_1_row_1) :black_small_square: [column_1_row_2](core-matrix.md#column_1_row_2) :black_small_square: [column_1_row_3](core-matrix.md#column_1_row_3) :black_small_square: [column_1_row_4](core-matrix.md#column_1_row_4) :black_small_square: [column_2_row_1](core-matrix.md#column_2_row_1) :black_small_square: [column_2_row_2](core-matrix.md#column_2_row_2) :black_small_square: [column_2_row_3](core-matrix.md#column_2_row_3) :black_small_square: [column_2_row_4](core-matrix.md#column_2_row_4) :black_small_square: [column_3_row_1](core-matrix.md#column_3_row_1) :black_small_square: [column_3_row_2](core-matrix.md#column_3_row_2) :black_small_square: [column_3_row_3](core-matrix.md#column_3_row_3) :black_small_square: [column_3_row_4](core-matrix.md#column_3_row_4) :black_small_square: [column_4_row_1](core-matrix.md#column_4_row_1) :black_small_square: [column_4_row_2](core-matrix.md#column_4_row_2) :black_small_square: [column_4_row_3](core-matrix.md#column_4_row_3) :black_small_square: [column_4_row_4](core-matrix.md#column_4_row_4) :black_small_square: [Combine](core-matrix.md#combine) :black_small_square: [CombineTransform](core-matrix.md#combinetransform) :black_small_square: [\_create_input_socket](core-matrix.md#_create_input_socket)
- **D** : [determinant](core-matrix.md#determinant)
- **E** : [enable_output](core-matrix.md#enable_output)
- **F** : [FromArray](core-matrix.md#fromarray)
- **H** : [hash_value](core-matrix.md#hash_value)
- **I** : [invert](core-matrix.md#invert)
- **M** : [multiply](core-matrix.md#multiply)
- **N** : [Named](core-matrix.md#named) :black_small_square: [NamedAttribute](core-matrix.md#namedattribute)
- **P** : [project_point](core-matrix.md#project_point)
- **R** : [rotation](core-matrix.md#rotation)
- **S** : [scale](core-matrix.md#scale) :black_small_square: [separate](core-matrix.md#separate) :black_small_square: [separate_matrix](core-matrix.md#separate_matrix) :black_small_square: [separate_transform](core-matrix.md#separate_transform) :black_small_square: [svd](core-matrix.md#svd)
- **T** : [transform_direction](core-matrix.md#transform_direction) :black_small_square: [transform_gizmo](core-matrix.md#transform_gizmo) :black_small_square: [transform_point](core-matrix.md#transform_point) :black_small_square: [translation](core-matrix.md#translation) :black_small_square: [transpose](core-matrix.md#transpose) :black_small_square: [trs](core-matrix.md#trs)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Matrix](core-matrix.md#matrix) :black_small_square: [Content](core-matrix.md#content) :black_small_square: [Properties](core-matrix.md#properties)</sub>
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Matrix](core-matrix.md#matrix) :black_small_square: [Content](core-matrix.md#content) :black_small_square: [Methods](core-matrix.md#methods)</sub>
