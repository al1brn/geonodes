...
``` python
Float(value=None, name: str = None, min: float = -3.40282e+38, max: float = 3.40282e+38, tip: str = '', panel: str = '', **props)
```
...
[add_method](group.md#add_method) :black_small_square: ['_bsocket' not found]() :black_small_square: [\_cache](nodecache.md#_cache) :black_small_square: ['_cached_nodes' not found]() :black_small_square: [\_cache_reset](nodecache.md#_cache_reset) :black_small_square: [check_in_list](core-socket.md#check_in_list) :black_small_square: [Constant](core-socket.md#constant) :black_small_square: [default_value](core-socket.md#default_value) :black_small_square: [\_domain_to_geometry](domain.md#_domain_to_geometry) :black_small_square: [Empty](core-socket.md#empty) :black_small_square: [\_\_enter__](layout.md#__enter__) :black_small_square: [\_\_exit__](layout.md#__exit__) :black_small_square: [\_\_getattr__](g.md#__getattr__) :black_small_square: [\_get_bsocket_from_input](core-socket.md#_get_bsocket_from_input) :black_small_square: [IndexSwitch](core-socket.md#indexswitch) :black_small_square: [index_switch](core-socket.md#index_switch) :black_small_square: [Input](input.md#input) :black_small_square: [\_interface_socket](core-socket.md#_interface_socket) :black_small_square: [\_is_empty](core-socket.md#_is_empty) :black_small_square: [is_grid](core-socket.md#is_grid) :black_small_square: [\_jump](domain.md#_jump) :black_small_square: ['_layout' not found]() :black_small_square: [\_lc](node.md#_lc) :black_small_square: [\_lcop](core-socket.md#_lcop) :black_small_square: [link_inputs](node.md#link_inputs) :black_small_square: [menu](core-gener-menu---menu.md#menu) :black_small_square: [MenuSwitch](core-socket.md#menuswitch) :black_small_square: [menu_switch](core-gener-menu-menu.md#menu_switch) :black_small_square: [\_name](core-socket.md#_name) :black_small_square: [NewInput](core-socket.md#newinput) :black_small_square: [node](core-socket.md#node) :black_small_square: [node_color](core-socket.md#node_color) :black_small_square: [node_label](core-socket.md#node_label) :black_small_square: [\_panel_name](core-socket.md#_panel_name) :black_small_square: [pin_gizmo](node.md#pin_gizmo) :black_small_square: [\_pop](core-closure.md#_pop) :black_small_square: [\_push](core-closure.md#_push) :black_small_square: [repeat](core-socket.md#repeat) :black_small_square: [\_reset](core-cloud.md#_reset) :black_small_square: [simulation](core-socket.md#simulation) :black_small_square: [\_socket_type](core-socket.md#_socket_type) :black_small_square: [\_\_str__](domain.md#__str__) :black_small_square: [Switch](core-socket.md#switch) :black_small_square: [switch](core-socket.md#switch) :black_small_square: [switch_false](core-socket.md#switch_false) :black_small_square: [\_test_socket_to_data_type](core-socket.md#_test_socket_to_data_type) :black_small_square: ['_tree' not found]() :black_small_square: [\_ul](core-socket.md#_ul) :black_small_square: ['_use_layout' not found]() :black_small_square: [user_label](core-socket.md#user_label) :black_small_square:

## Content

- **A** : [abs](core-float.md#abs) :black_small_square: [acos](core-float.md#acos) :black_small_square: [add](core-float.md#add) :black_small_square: [advect_grid](core-float.md#advect_grid) :black_small_square: [Angle](core-float.md#angle) :black_small_square: [arctangent](core-float.md#arctangent) :black_small_square: [asin](core-float.md#asin) :black_small_square: [atan2](core-float.md#atan2)
- **B** : [bevel](core-float.md#bevel) :black_small_square: [blur](core-float.md#blur) :black_small_square: [bump](core-float.md#bump)
- **C** : [ceil](core-float.md#ceil) :black_small_square: [clamp](core-float.md#clamp) :black_small_square: [clamp_minmax](core-float.md#clamp_minmax) :black_small_square: [clamp_range](core-float.md#clamp_range) :black_small_square: [clip_grid](core-float.md#clip_grid) :black_small_square: [color_ramp](core-float.md#color_ramp) :black_small_square: [ColorTemperature](core-float.md#colortemperature) :black_small_square: [combine_color](core-float.md#combine_color) :black_small_square: [combine_color_HSL](core-float.md#combine_color_hsl) :black_small_square: [combine_color_HSV](core-float.md#combine_color_hsv) :black_small_square: [combine_color_RGB](core-float.md#combine_color_rgb) :black_small_square: [compare](core-float.md#compare) :black_small_square: [cos](core-float.md#cos) :black_small_square: [cosh](core-float.md#cosh) :black_small_square: [\_create_input_socket](core-float.md#_create_input_socket) :black_small_square: [curve](core-float.md#curve)
- **D** : [degrees](core-float.md#degrees) :black_small_square: [dial_gizmo](core-float.md#dial_gizmo) :black_small_square: [displacement](core-float.md#displacement) :black_small_square: [Distance](core-float.md#distance) :black_small_square: [distribute_points_in_grid](core-float.md#distribute_points_in_grid) :black_small_square: [distribute_points_in_grid_density_grid](core-float.md#distribute_points_in_grid_density_grid) :black_small_square: [distribute_points_in_grid_density_random](core-float.md#distribute_points_in_grid_density_random) :black_small_square: [divide](core-float.md#divide)
- **E** : [enable_output](core-float.md#enable_output) :black_small_square: [equal](core-float.md#equal) :black_small_square: [exp](core-float.md#exp)
- **F** : [Factor](core-float.md#factor) :black_small_square: [field_to_grid](core-float.md#field_to_grid) :black_small_square: [floor](core-float.md#floor) :black_small_square: [floored_modulo](core-float.md#floored_modulo) :black_small_square: [fract](core-float.md#fract) :black_small_square: [Frequency](core-float.md#frequency) :black_small_square: [fresnel](core-float.md#fresnel)
- **G** : [Gabor](core-float.md#gabor) :black_small_square: [greater_equal](core-float.md#greater_equal) :black_small_square: [greater_than](core-float.md#greater_than) :black_small_square: [grid_dilate_erode](core-float.md#grid_dilate_erode) :black_small_square: [grid_gradient](core-float.md#grid_gradient) :black_small_square: [grid_info](core-float.md#grid_info) :black_small_square: [grid_laplacian](core-float.md#grid_laplacian) :black_small_square: [grid_mean](core-float.md#grid_mean) :black_small_square: [grid_median](core-float.md#grid_median) :black_small_square: [grid_to_mesh](core-float.md#grid_to_mesh) :black_small_square: [grid_to_points](core-float.md#grid_to_points)
- **H** : [hash_value](core-float.md#hash_value) :black_small_square: [hue_saturation_value](core-float.md#hue_saturation_value)
- **I** : [\_\_init__](core-float.md#__init__) :black_small_square: [inverse_sqrt](core-float.md#inverse_sqrt)
- **L** : [layer_weight](core-float.md#layer_weight) :black_small_square: [less_equal](core-float.md#less_equal) :black_small_square: [less_than](core-float.md#less_than) :black_small_square: [light_falloff](core-float.md#light_falloff) :black_small_square: [linear_gizmo](core-float.md#linear_gizmo) :black_small_square: [log](core-float.md#log)
- **M** : [map_range](core-float.md#map_range) :black_small_square: [map_range_linear](core-float.md#map_range_linear) :black_small_square: [map_range_smoother_step](core-float.md#map_range_smoother_step) :black_small_square: [map_range_smooth_step](core-float.md#map_range_smooth_step) :black_small_square: [map_range_stepped](core-float.md#map_range_stepped) :black_small_square: [Mass](core-float.md#mass) :black_small_square: [max](core-float.md#max) :black_small_square: [mgreater_than](core-float.md#mgreater_than) :black_small_square: [min](core-float.md#min) :black_small_square: [mix](core-float.md#mix) :black_small_square: [mless_than](core-float.md#mless_than) :black_small_square: [modulo](core-float.md#modulo) :black_small_square: [multiply](core-float.md#multiply) :black_small_square: [multiply_add](core-float.md#multiply_add)
- **N** : [Named](core-float.md#named) :black_small_square: [NamedAttribute](core-float.md#namedattribute) :black_small_square: [Noise](core-float.md#noise) :black_small_square: [normal_map](core-float.md#normal_map) :black_small_square: [not_equal](core-float.md#not_equal)
- **O** : [out](core-float.md#out)
- **P** : [Percentage](core-float.md#percentage) :black_small_square: [pingpong](core-float.md#pingpong) :black_small_square: [power](core-float.md#power) :black_small_square: [prune_grid](core-float.md#prune_grid)
- **R** : [radians](core-float.md#radians) :black_small_square: [Random](core-float.md#random) :black_small_square: [round](core-float.md#round)
- **S** : [sample_grid](core-float.md#sample_grid) :black_small_square: [sample_grid_index](core-float.md#sample_grid_index) :black_small_square: [sdf_difference](core-float.md#sdf_difference) :black_small_square: [sdf_grid_boolean](core-float.md#sdf_grid_boolean) :black_small_square: [sdf_grid_fillet](core-float.md#sdf_grid_fillet) :black_small_square: [sdf_grid_laplacian](core-float.md#sdf_grid_laplacian) :black_small_square: [sdf_grid_mean](core-float.md#sdf_grid_mean) :black_small_square: [sdf_grid_mean_curvature](core-float.md#sdf_grid_mean_curvature) :black_small_square: [sdf_grid_median](core-float.md#sdf_grid_median) :black_small_square: [sdf_grid_offset](core-float.md#sdf_grid_offset) :black_small_square: [sdf_intersect](core-float.md#sdf_intersect) :black_small_square: [sdf_union](core-float.md#sdf_union) :black_small_square: [set_grid_background](core-float.md#set_grid_background) :black_small_square: [set_grid_transform](core-float.md#set_grid_transform) :black_small_square: [sign](core-float.md#sign) :black_small_square: [sin](core-float.md#sin) :black_small_square: [sinh](core-float.md#sinh) :black_small_square: [smooth_max](core-float.md#smooth_max) :black_small_square: [smooth_min](core-float.md#smooth_min) :black_small_square: [snap](core-float.md#snap) :black_small_square: [sqrt](core-float.md#sqrt) :black_small_square: [subtract](core-float.md#subtract)
- **T** : [tan](core-float.md#tan) :black_small_square: [tanh](core-float.md#tanh) :black_small_square: [Time](core-float.md#time) :black_small_square: [TimeAbsolute](core-float.md#timeabsolute) :black_small_square: [to_integer](core-float.md#to_integer) :black_small_square: [to_string](core-float.md#to_string) :black_small_square: [trunc](core-float.md#trunc)
- **V** : [Voronoi](core-float.md#voronoi) :black_small_square: [voxel_index](core-float.md#voxel_index) :black_small_square: [voxelize_grid](core-float.md#voxelize_grid)
- **W** : [Wavelength](core-float.md#wavelength) :black_small_square: [wavelength](core-float.md#wavelength) :black_small_square: [WhiteNoise](core-float.md#whitenoise) :black_small_square: [wireframe](core-float.md#wireframe) :black_small_square: [wrap](core-float.md#wrap)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Float](core-float.md#float) :black_small_square: [Content](core-float.md#content) :black_small_square: [Methods](core-float.md#methods)</sub>
...
``` python
__init__(value=None, name: str = None, min: float = -3.40282e+38, max: float = 3.40282e+38, tip: str = '', panel: str = '', **props)
```
