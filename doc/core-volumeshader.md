...
``` python
VolumeShader(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- [Absorption](core-volumeshader.md#absorption)
- [Principled](core-volumeshader.md#principled)
- [Scatter](core-volumeshader.md#scatter)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [VolumeShader](core-volumeshader.md#volumeshader) :black_small_square: [Content](core-volumeshader.md#content) :black_small_square: [Methods](core-volumeshader.md#methods)</sub>
...
- **density** (_Float_ = None) : socket 'Density' (id: Density)
- **anisotropy** (_Float_ = None) : socket 'Anisotropy' (id: Anisotropy)
- **phase** (_Literal['HENYEY_GREENSTEIN', 'FOURNIER_FORAND', 'DRAINE', 'RAYLEIGH', 'MIE']_ = HENYEY_GREENSTEIN) : parameter 'phase' in ('Henyey-Greenstein', 'Fournier-Forand', 'Draine', 'Rayleigh', 'Mie')
