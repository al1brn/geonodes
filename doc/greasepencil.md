...
#### Arguments:
- **mode** (_Literal['MERGE_BY_NAME', 'MERGE_BY_ID']_ = MERGE_BY_NAME) : parameter 'mode' in ['MERGE_BY_NAME', 'MERGE_BY_ID']
...
#### Arguments:
- **depth_order** (_Literal['2D', '3D']_ = 2D) : parameter 'depth_order' in ['2D', '3D']
