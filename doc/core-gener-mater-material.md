...
``` python
Material(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- [\_create_input_socket](core-gener-mater-material.md#_create_input_socket)
- [enable_output](core-gener-mater-material.md#enable_output)
...
New [Material](core-gener-mater-material.md#material) input with subtype 'NONE'.
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Material](core-gener-mater-material.md#material) :black_small_square: [Content](core-gener-mater-material.md#content) :black_small_square: [Methods](core-gener-mater-material.md#methods)</sub>
