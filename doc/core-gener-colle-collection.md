...
``` python
Collection(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- [\_create_input_socket](core-gener-colle-collection.md#_create_input_socket)
- [enable_output](core-gener-colle-collection.md#enable_output)
- [info](core-gener-colle-collection.md#info)
...
New [Collection](core-gener-colle-collection.md#collection) input with subtype 'NONE'.
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Collection](core-gener-colle-collection.md#collection) :black_small_square: [Content](core-gener-colle-collection.md#content) :black_small_square: [Methods](core-gener-colle-collection.md#methods)</sub>
