...
``` python
add_method(group_name: str, target_class: type, *, func_name: str = None, self_attr: str = None, ret_class: type = None, prefix: str = '', **fixed)
```
