...
``` python
Font(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- [\_create_input_socket](core-gener-font-font.md#_create_input_socket)
- [enable_output](core-gener-font-font.md#enable_output)
...
``` python
_create_input_socket(value: 'object' = None, name: 'str' = 'Font', tip: 'str' = '', panel: 'str' = '', optional_label: 'bool' = True, hide_value: 'bool' = False, hide_in_modifier: 'bool' = False)
```

> Font Input

New [Font](core-gener-font-font.md#font) input with subtype 'NONE'.

Aguments
--------
- value  (object = None) : Default value
- name  (str = 'Font') : Input socket name
- tip  (str = '') : Property description
panel : str, optional
    Panel name Default: "".

- optional_label  (bool = True) : Property optional_label
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Font](core-gener-font-font.md#font) :black_small_square: [Content](core-gener-font-font.md#content) :black_small_square: [Methods](core-gener-font-font.md#methods)</sub>
