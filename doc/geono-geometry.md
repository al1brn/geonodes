...
- **J** : [Join](geono-geometry.md#join) :black_small_square: [join](geono-geometry.md#join)
...
> See also [join](geono-geometry.md#join) method
...
> - Constructur [Join](geono-geometry.md#join) : create an new geometry from the input geometries
