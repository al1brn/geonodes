...
``` python
Menu(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
New [Menu](core-gener-menu-menu.md#menu) input with subtype 'NONE'.
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Menu](core-gener-menu-menu.md#menu) :black_small_square: [Content](core-gener-menu-menu.md#content) :black_small_square: [Methods](core-gener-menu-menu.md#methods)</sub>
