...
``` python
Mesh(value: geonodes.core.socket_class.Socket = None, name: str = None, tip: str = '', panel: str = '', **props)
```
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Mesh](core-mesh.md#mesh) :black_small_square: [Content](core-mesh.md#content) :black_small_square: [Properties](core-mesh.md#properties)</sub>
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Mesh](core-mesh.md#mesh) :black_small_square: [Content](core-mesh.md#content) :black_small_square: [Methods](core-mesh.md#methods)</sub>
