...
- [\_create_input_socket](core-image.md#_create_input_socket)
- [enable_output](core-image.md#enable_output)
- [fps](core-image.md#fps)
- [frame_count](core-image.md#frame_count)
- [has_alpha](core-image.md#has_alpha)
- [height](core-image.md#height)
- [image_texture](core-image.md#image_texture)
- [info](core-image.md#info)
- [width](core-image.md#width)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Image](core-image.md#image) :black_small_square: [Content](core-image.md#content) :black_small_square: [Methods](core-image.md#methods)</sub>
