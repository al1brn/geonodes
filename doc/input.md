...
``` python
Input(name: str = None, panel: str = '', **props)
```
...
``` python
__init__(name: str = None, panel: str = '', **props)
```
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Input](input.md#input) :black_small_square: [Content](input.md#content) :black_small_square: [Methods](input.md#methods)</sub>