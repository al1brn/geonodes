...
> - [Impossible to find the section 'insts' in page 'Instances'](core-gener-insta-instances.md#instances) : name of the domain property of class [Instances](core-gener-insta-instances.md#instances)
...
- setter : [Rotate Instances](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/instances/rotate_instances.html)
 ...
 Rotation can be set either by a [Rotation](core-gener-rotat-rotation.md#rotation) argument or by a dict with keys
...
Scale can be set either by a [Vector](core-gener-vecto-vector.md#vector) argument or by a dict with keys
...
#### Arguments:
- **mode** (_Literal['ALL', 'EDGE_FACE', 'ONLY_FACE']_ = ALL) : parameter 'mode' in ('All', 'Only Edges & Faces', 'Only Faces')
