...
``` python
Texture(socket=None, name: str = None, tip: str = '', panel: str = '', user_label: str = None, **props)
```
...
- [Brick](core-gener-textu-texture.md#brick)
- [Checker](core-gener-textu-texture.md#checker)
- [Gabor](core-gener-textu-texture.md#gabor)
- [Gradient](core-gener-textu-texture.md#gradient)
- [Magic](core-gener-textu-texture.md#magic)
- [Noise](core-gener-textu-texture.md#noise)
- [Voronoi](core-gener-textu-texture.md#voronoi)
- [Wave](core-gener-textu-texture.md#wave)
- [WhiteNoise](core-gener-textu-texture.md#whitenoise)
...
##### <sub>:arrow_right: [geonodes](index.md#geonodes) :black_small_square: [Texture](core-gener-textu-texture.md#texture) :black_small_square: [Content](core-gener-textu-texture.md#content) :black_small_square: [Methods](core-gener-textu-texture.md#methods)</sub>
