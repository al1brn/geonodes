...
with gn.Tree('Geometry Nodes') as tree:
    ...
    mesh.edges.raycast()
    mesh.faces.raycast()
    mesh.corners.raycast()
    curve.points.raycast()
    curve.splines.raycast()
    instances.insts.raycast()
    points.points.raycast()
    mesh.verts.raycast_interpolated()
    mesh.edges.raycast_interpolated()
    mesh.faces.raycast_interpolated()
    mesh.corners.raycast_interpolated()
    curve.points.raycast_interpolated()
    curve.splines.raycast_interpolated()
    instances.insts.raycast_interpolated()
    points.points.raycast_interpolated()
    mesh.verts.raycast_nearest()
    mesh.edges.raycast_nearest()
    mesh.faces.raycast_nearest()
    mesh.corners.raycast_nearest()
    curve.points.raycast_nearest()
    curve.splines.raycast_nearest()
    instances.insts.raycast_nearest()
    points.points.raycast_nearest()
    ...
    var = mesh.material_index
    mesh.material_selection()
    mesh.set_material()
    mesh.dual_mesh()
    ...
    points.named_float()
    points.named_integer()
    points.named_vector()
    points.named_color()
    points.named_boolean()
    var = points.normal
    var = points.position
    var = points.radius
    points.instance_on_points()
    var = points.material_index
    points.material_selection()
    points.set_material()
    ...
    instances.named_float()
    instances.named_integer()
    instances.named_vector()
    instances.named_color()
    instances.named_boolean()
    var = instances.normal
    var = instances.position
    ...
    mesh.verts.shortest_edge_paths()
    ...
    points.points.material_index = None
    ...
    var = gn.Texture.GradientLinear()
    var = gn.Texture.GradientQuadratic()
    var = gn.Texture.GradientEeasing()
    var = gn.Texture.GradientDiagonal()
    var = gn.Texture.GradientSpherical()
    var = gn.Texture.GradientQuadratic_sphere()
    var = gn.Texture.GradientRadial()
    var = gn.Texture.Image()
    var = gn.Texture.Magic()
    var = gn.Texture.Musgrave()
    var = gn.Texture.Noise()
    var = gn.Texture.Noise1D()
    var = gn.Texture.Noise2D()
    var = gn.Texture.Noise3D()
    var = gn.Texture.Noise4D()
    var = gn.Texture.Voronoi()
    var = gn.Texture.Voronoi1D()
    var = gn.Texture.Voronoi2D()
    var = gn.Texture.Voronoi3D()
    var = gn.Texture.Voronoi4D()
    var = gn.Texture.Wave()
    var = gn.Texture.WaveBands()
    var = gn.Texture.WaveRings()
    var = gn.Texture.WaveBands_sine()
    var = gn.Texture.WaveBands_saw()
    var = gn.Texture.WaveBands_triangle()
    var = gn.Texture.WaveRings_sine()
    var = gn.Texture.WaveRings_saw()
    var = gn.Texture.WaveRings_triangle()
    var = gn.Texture.WhiteNoise()
    var = gn.Texture.WhiteNoise1D()
    var = gn.Texture.WhiteNoise2D()
    var = gn.Texture.WhiteNoise3D()
    var = gn.Texture.WhiteNoise4D()
    texture.switch()
    collection.switch()
