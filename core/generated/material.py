...
class Material(Socket):
    ...
    def list_length(self):
        ...
        **Fixed values**
        ...
        Integer
        """
        node = Node('List Length', {'List': self}, data_type='MATERIAL')
        return node._out
    ...
    def sort_list(self,
        ...
        **Fixed values**
        ...
        | --------- | ------------- | ------------ |
        | Socket    | List          | `self`       |
        | Parameter | `socket_type` | `'MATERIAL'` |
        ...
        Material
        """
        node = Node('Sort List', {'List': self, 'Selection': selection, 'Group ID': group_id, 'Sort Weight': sort_weight}, socket_type='MATERIAL')
        return node._out
    ...
    def filter_list(self, selection: Boolean = None):
        ...
        **Fixed values**
        ...
        -------
        Material
            peer sockets: inverted_ (Material)

        """
        node = Node('Filter List', {'List': self, 'Selection': selection}, socket_type='MATERIAL')
        return node._out
    ...
    def get_list_item(self,
        ...
        **Fixed values**
        ...
        node = Node('Get List Item', {'List': self, 'Index': index}, socket_type='MATERIAL', structure_type=structure_type)
        return node._out
    ...
    def implicit_conversion(self, socket_idname = 'NodeSocketColor'):
        ...
        **Fixed values**
        ...
        Material
        """
        node = Node('Implicit Conversion', {'Value': self}, data_type='MATERIAL', socket_idname=socket_idname)
        return node._out
