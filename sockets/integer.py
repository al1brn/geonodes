...
class Integer(dsock.Integer):
    ...
    Constructors
    ============
    - **self.meth_name** : RandomValue value (Integer) 
    

    Methods
    =======
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : AccumulateField Sockets      [leading (Integer), trailing (Integer), total (Integer)]
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : CaptureAttribute Sockets      [geometry (Geometry), attribute (Integer)] 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    ...
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : FieldAtIndex value (Integer) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Compare result (Boolean) 
    - **self.meth_name** : Compare result (Boolean) 
    ...
    - **self.meth_name** : Raycast Sockets      [is_hit (Boolean), hit_position (Vector), hit_normal (Vector),
      hit_distance (Float), attribute (Integer)] 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    ...
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Switch output (Integer) 
    - **self.meth_name** : Math value (Float) 
    - **self.meth_name** : Math value (Float) 
