...
- [Random](#random) : [RandomValue](section:nodes/RandomValue.md), value (Integer)

## Methods

- [abs](#abs) : [Math](section:nodes/Math.md), value (Float)
- [accumulate_field](#accumulate_field) : [AccumulateField](section:nodes/AccumulateField.md), Sockets      [leading (Integer), trailing (Integer), total (Integer)]
...
- [capture_attribute](#capture_attribute) : [CaptureAttribute](section:nodes/CaptureAttribute.md), Sockets      [geometry (Geometry), attribute (Integer)]
...
- [field_at_index](#field_at_index) : [FieldAtIndex](section:nodes/FieldAtIndex.md), value (Integer)
...
- [raycast](#raycast) : [Raycast](section:nodes/Raycast.md), Sockets      [is_hit (Boolean), hit_position (Vector), hit_normal (Vector), hit_distance (Float), attribute (Integer)]
...
- [switch](#switch) : [Switch](section:nodes/Switch.md), output (Integer)
- [tan](#tan) : [Math](section:nodes/Math.md), value (Float)
- [tanh](#tanh) : [Math](section:nodes/Math.md), value (Float)
- [transfer_attribute](#transfer_attribute) : [TransferAttribute](section:nodes/TransferAttribute.md), attribute (Integer)
...
<sub>go to: [top](#integer) [index](TBD)
