...
- [**Random**](#random) : [RandomValue](../nodes/RandomValue.md) value (Integer)
...
- [**accumulate_field**](#accumulate_field) : [AccumulateField](../nodes/AccumulateField.md) Sockets      [leading (Integer), trailing (Integer), total (Integer)]
...
- [**capture_attribute**](#capture_attribute) : [CaptureAttribute](../nodes/CaptureAttribute.md) Sockets      [geometry (Geometry), attribute (Integer)]
...
- [**field_at_index**](#field_at_index) : [FieldAtIndex](../nodes/FieldAtIndex.md) value (Integer)
...
- [**raycast**](#raycast) : [Raycast](../nodes/Raycast.md) Sockets      [is_hit (Boolean), hit_position (Vector), hit_normal (Vector), hit_distance (Float), attribute (Integer)]
...
- [**switch**](#switch) : [Switch](../nodes/Switch.md) output (Integer)
- [**tan**](#tan) : [Math](../nodes/Math.md) value (Float)
- [**tanh**](#tanh) : [Math](../nodes/Math.md) value (Float)
- [**transfer_attribute**](#transfer_attribute) : [TransferAttribute](../nodes/TransferAttribute.md) attribute (Integer)
...
[Top](#class-integer) [Index](/docs/index.md)
