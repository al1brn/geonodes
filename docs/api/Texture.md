...
Node [Brick Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
Node [Checker Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
Node [Gradient Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
## gradient_diagonal *staticmethod* {#gradient_diagonal}
...
## gradient_easing *staticmethod* {#gradient_easing}
...
## gradient_linear *staticmethod* {#gradient_linear}
...
## gradient_quadratic *staticmethod* {#gradient_quadratic}
...
## gradient_quadratic_sphere *staticmethod* {#gradient_quadratic_sphere}
...
## gradient_radial *staticmethod* {#gradient_radial}
...
## gradient_spherical *staticmethod* {#gradient_spherical}
...
Node [Magic Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
## musgrave *staticmethod* {#musgrave}
...
Node [Musgrave Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
Node [Noise Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
## noise_1D *staticmethod* {#noise_1D}
...
## noise_2D *staticmethod* {#noise_2D}
...
## noise_3D *staticmethod* {#noise_3D}
...
## noise_4D *staticmethod* {#noise_4D}
...
Node [Voronoi Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
## voronoi_1D *staticmethod* {#voronoi_1D}
...
## voronoi_2D *staticmethod* {#voronoi_2D}
...
## voronoi_3D *staticmethod* {#voronoi_3D}
...
## voronoi_4D *staticmethod* {#voronoi_4D}
...
Node [Wave Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
## wave_bands *staticmethod* {#wave_bands}
...
## wave_bands_saw *staticmethod* {#wave_bands_saw}
...
## wave_bands_sine *staticmethod* {#wave_bands_sine}
...
## wave_bands_triangle *staticmethod* {#wave_bands_triangle}
...
## wave_rings *staticmethod* {#wave_rings}
...
## wave_rings_saw *staticmethod* {#wave_rings_saw}
...
## wave_rings_sine *staticmethod* {#wave_rings_sine}
...
## wave_rings_triangle *staticmethod* {#wave_rings_triangle}
...
## white_noise *staticmethod* {#white_noise}

> def white_noise(vector=None, w=None, noise_dimensions='3D'):

Node [White Noise Texture](node.blender_ref) ( [api](node.blender_python_ref) )
...
## white_noise_1D *staticmethod* {#white_noise_1D}
...
## white_noise_2D *staticmethod* {#white_noise_2D}
...
## white_noise_3D *staticmethod* {#white_noise_3D}
...
## white_noise_4D *staticmethod* {#white_noise_4D}
