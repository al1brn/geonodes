...
<sub>Go to [top](#class-Edge)</sub>
  ...
  socket 'curves'<sub>Go to [top](#class-Edge)</sub>
...
<sub>Go to [top](#class-Edge)</sub>
  ...
  socket 'face_count'<sub>Go to [top](#class-Edge)</sub>
...
<sub>Go to [top](#class-Edge)</sub>
  ...
  socket 'signed_angle'<sub>Go to [top](#class-Edge)</sub>
...
<sub>Go to [top](#class-Edge)</sub>
  ...
  socket 'curve'<sub>Go to [top](#class-Edge)</sub>
...
<sub>Go to [top](#class-Edge)</sub>
  ...
  socket 'unsigned_angle'<sub>Go to [top](#class-Edge)</sub>
