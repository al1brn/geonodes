...
- [(gen.fname(wnode)](Integer-classmethod)
...
- [(gen.fname(wnode)](fact)
- [(gen.fname(wnode)](fraction)
- [(gen.fname(wnode)](greater_equal)
- [(gen.fname(wnode)](greater_than)
- [(gen.fname(wnode)](inverse_sqrt)
- [(gen.fname(wnode)](less_equal)
- [(gen.fname(wnode)](less_than)
- [(gen.fname(wnode)](log)
