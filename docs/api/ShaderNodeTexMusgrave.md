...
|----------------------|------------|
| **[Texture](Texture.md)** |
| [Musgrave](Texture.md#Musgrave) | `@classmethod`<br> `def Musgrave(cls, vector=None, w=None, scale=None, detail=None, dimension=None, lacunarity=None, offset=None, gain=None, musgrave_dimensions='3D', musgrave_type='FBM'):` |
