...
|----------------------|------------|
| **[Texture](Texture.md)** |
| [Brick](Texture.md#Brick) | `@classmethod`<br> `def Brick(cls, vector=None, color1=None, color2=None, mortar=None, scale=None, mortar_size=None, mortar_smooth=None, bias=None, brick_width=None, row_height=None, offset=0.5, offset_frequency=2, squash=1.0, squash_frequency=2):` |
