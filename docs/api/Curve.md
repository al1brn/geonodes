...
<sub>Go to [top](#class-Curve)</sub>
  ...
  socket 'curve'<sub>Go to [top](#class-Curve)</sub>
...
<sub>Go to [top](#class-Curve)</sub>
  ...
  socket 'mesh'<sub>Go to [top](#class-Curve)</sub>
...
<sub>Go to [top](#class-Curve)</sub>
  ...
  socket 'instances'<sub>Go to [top](#class-Curve)</sub>
...
<sub>Go to [top](#class-Curve)</sub>
  ...
  socket 'length'<sub>Go to [top](#class-Curve)</sub>
...
<sub>Go to [top](#class-Curve)</sub>
  ...
  socket 'point_count'<sub>Go to [top](#class-Curve)</sub>
...
<sub>Go to [top](#class-Curve)</sub>
  ...
  socket 'spline_count'<sub>Go to [top](#class-Curve)</sub>
