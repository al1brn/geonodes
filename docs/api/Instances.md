...
<sub>Go to [top](#class-Instances)</sub>
  ...
  socket 'instances'<sub>Go to [top](#class-Instances)</sub>
...
<sub>Go to [top](#class-Instances)</sub>
  ...
  socket 'instance_count'<sub>Go to [top](#class-Instances)</sub>
...
<sub>Go to [top](#class-Instances)</sub>
  ...
  socket 'geometry'<sub>Go to [top](#class-Instances)</sub>
...
<sub>Go to [top](#class-Instances)</sub>
  ...
  socket 'rotation'<sub>Go to [top](#class-Instances)</sub>
...
<sub>Go to [top](#class-Instances)</sub>
  ...
  socket 'scale'<sub>Go to [top](#class-Instances)</sub>
...
<sub>Go to [top](#class-Instances)</sub>
  ...
  socket 'points'<sub>Go to [top](#class-Instances)</sub>
