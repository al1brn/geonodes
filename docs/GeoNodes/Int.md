...
def blur_attribute(self, iterations=None, weight=None, node_label=None, node_color=None):
    node = self.tree.BlurAttribute(value=self, iterations=iterations, weight=weight, data_type='INT', node_label=node_label, node_color=node_color)
    return node.value
```
### ceil
...
def equal(self, b=None, mode='ELEMENT', node_label=None, node_color=None):
    node = self.tree.Compare(a=self, b=b, data_type='INT', mode=mode, operation='EQUAL', node_label=node_label, node_color=node_color)
    return node.result
```
### exp
...
def greater_equal(self, b=None, mode='ELEMENT', node_label=None, node_color=None):
    node = self.tree.Compare(a=self, b=b, data_type='INT', mode=mode, operation='GREATER_EQUAL', node_label=node_label, node_color=node_color)
    return node.result
```
### greater_than
...
def greater_than(self, b=None, mode='ELEMENT', node_label=None, node_color=None):
    node = self.tree.Compare(a=self, b=b, data_type='INT', mode=mode, operation='GREATER_THAN', node_label=node_label, node_color=node_color)
    return node.result
```
### inverse_sqrt
...
def less_equal(self, b=None, mode='ELEMENT', node_label=None, node_color=None):
    node = self.tree.Compare(a=self, b=b, data_type='INT', mode=mode, operation='LESS_EQUAL', node_label=node_label, node_color=node_color)
    return node.result
```
### less_than
...
def less_than(self, b=None, mode='ELEMENT', node_label=None, node_color=None):
    node = self.tree.Compare(a=self, b=b, data_type='INT', mode=mode, operation='LESS_THAN', node_label=node_label, node_color=node_color)
    return node.result
```
### log
...
def not_equal(self, b=None, mode='ELEMENT', node_label=None, node_color=None):
    node = self.tree.Compare(a=self, b=b, data_type='INT', mode=mode, operation='NOT_EQUAL', node_label=node_label, node_color=node_color)
    return node.result
```
### pingpong
...
def switch(self, switch=None, true=None, node_label=None, node_color=None):
    node = self.tree.Switch(switch=switch, false=self, true=true, input_type='INT', node_label=node_label, node_color=node_color)
    return node.output
```
### tan
