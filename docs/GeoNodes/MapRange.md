...
- [INT](/docs/GeoNodes/socket_INT.md) : [map_range](/docs/GeoNodes/socket_INT.md#map_range)
- [VALUE](/docs/GeoNodes/socket_VALUE.md) : [map_range](/docs/GeoNodes/socket_VALUE.md#map_range)
- [VECTOR](/docs/GeoNodes/socket_VECTOR.md) : [map_range](/docs/GeoNodes/socket_VECTOR.md#map_range)
