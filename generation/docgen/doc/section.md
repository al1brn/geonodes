...
- A : [add_hook](#add_hook) [alphabetical_sections](#alphabetical_sections) 
...
``` python
Section.add_hook(cls, expr, func)
```
...
Due to the piece of code above, the token `[substitution textsubstitution textsubstitution textsubstitution textsubstitution textsubstitution text]` is replaced by `substitution text': **[substitution textsubstitution textsubstitution textsubstitution textsubstitution textsubstitution text]**
