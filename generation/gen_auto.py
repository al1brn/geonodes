...
'Instance on Points' :          [{name: 'instance_on_points'}, {name: 'instance_on', klass:'Cloud'}],
...
'Set Face Set'       :          [{}],
'Set Selection'      :          [{}],
'Transform Geometry' :          [{only_enabled: False, 'mode_loop': False}, {name: 'transform'}],
'Translate Instances' :         [{name: 'translate'}],
'Triangulate'        :          [{}],
'Trim Curve'         :          [{name: 'trim'}],
'Pack UV Islands'    :          [{}, {domain: 'CORNER'}],
'UV Unwrap'          :          [{}, {domain: 'CORNER'}],
'Vertex of Corner'   :          [{klass: 'Mesh'}, {name: 'vertex', klass: 'Corner'}],
'Viewer'             :          [{ret: None}],
...
"""
GEONODES_CLASS_METHODS = {
    {klass: 'Mesh', name: 'normal',                 getter: 'Normal'},
    {klass: 'Mesh', name: 'shortes_edge_paths',     getter: 'Shortes Edge Paths'},

    {klass: 'GreasePencil', name: 'named_layer_selection', getter: 'Named Layer Selection'},
}
