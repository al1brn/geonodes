...
'Separate Matrix'    :          [{f: 'get', name: 'as_tuple', cache: True, ret: 'TUPLE'},
                                 {name: 'separate'},
                                 #{f: 'get', name: 'separate', cache: True, ret: 'TUPLE'},
...
'Get Geometry Component' :      [{name: 'get_component'},
                                 {name: 'get_mesh', parameters: {'Type': 'Mesh'},               ret: 'Component', 'ret_class': 'Mesh'},
                                 {name: 'get_cloud', parameters: {'Type': 'Point Cloud'},       ret: 'Component', 'ret_class': 'Cloud'},
                                 {name: 'get_point_cloud', parameters: {'Type': 'Point Cloud'}, ret: 'Component', 'ret_class': 'Cloud'},
                                 {name: 'get_curve', parameters: {'Type': 'Curve'},             ret: 'Component', 'ret_class': 'Curve'},
                                 {name: 'get_instances', parameters: {'Type': 'Instances'},     ret: 'Component', 'ret_class': 'Instances'},
                                 {name: 'get_grease_pencil', parameters: {'Type': 'Grease Pencil'}, ret: 'Component', 'ret_class': 'GreasePencil'},
                                 {name: 'get_volume', parameters: {'Type': 'Volume'},           ret: 'Component', 'ret_class': 'Volume'},
                                ],
'Attribute Statistic' :         [{ret: 'NODE'}],
'Field Average'      :          [{klass: ('Point', 'Edge', 'Face', 'Corner', 'Spline', 'Instance', 'Layer'), is_cm: True, 'domain_loop': False, 'data_type_loop': False, ret: 'NODE'}],
'Field Min & Max'    :          [{klass: ('Point', 'Edge', 'Face', 'Corner', 'Spline', 'Instance', 'Layer'), is_cm: True, 'domain_loop': False, 'data_type_loop': False, ret: 'NODE'}],
'Field Variance'     :          [{klass: ('Point', 'Edge', 'Face', 'Corner', 'Spline', 'Instance', 'Layer'), is_cm: True, 'domain_loop': False, 'data_type_loop': False, ret: 'NODE'}],
...
'Collection Children' :         [{name: 'children'}],
'Convex Hull'        :          [{f: 'get'}],
...
'Format String'      :          [{name: 'format'}, {f: 'C', name: 'Format'}],
...
'Import CSV'         :          [{f: 'C', name: 'ImportCSV'}],
'Import Text'        :          [{f: 'C', name: 'ImportText'}],
...
'ID'                 :          [{f: 'STATIC'}],
'Image'              :          [{f: 'INIT'}],
'Index'              :          [{f: 'STATIC'}, {klass: 'Geometry'}],
'Instance Reference' :          [{f: 'STATIC'}, {name: 'reference', klass: ('Instances', 'Instance')}],
...
'Merge Points'       :          [{}, {name: 'merge', klass: 'Point'}],
...
'Set String Case'    :          [{name: 'set_case'}, 
                                 {name: 'lower', 'Case': 'Lowercase'}, 
                                 {name: 'upper', 'Case': 'Uppercase'}, 
                                 ],
'Set NURBS Order'    :          [{}],
'Set NURBS Weight'   :          [{}],
...
'Filter List'        :          [{}],
'Get List Item'      :          [{}],
'Closure to List'    :          [{f: 'MANUAL'}],
'Get Attribute Names' :         [{f: "MANUAL"}],
'Transfer Attributes' :         [{}],
'Get Geometry Bundle':          [{name: 'get_bundle', ret: 'bundle'}],
'Set Geometry Bundle':          [{name: 'set_bundle'}],
'Clip Grid'          :          [{}],
'Grid Dilate & Erode':          [{}],
'Grid Mean'          :          [{}],
'Grid Median'        :          [{}],
...
'XPBD Solver'        :          [{}],
'Get Nested Bundle Paths' :     [{name: 'get_nested_paths'}], 

'Implicit Conversion' :         [{}],
'Cluster by Connected' :        [{klass: 'Geometry'}],
'Cluster by Distance' :         [{klass: 'Geometry'}],
...
GEONODES_PROPS = [
    ...
    {name: 'stroke_color', setter: 'Set Grease Pencil Color', 'setter_params': {'mode': 'STROKE'}},
