...
class Node:
    ...
    **Sockets naming convention**
    ...
    """
    def plug_with_data_type(self, value, socket_name, driving_param='data_type'):
        
        # ----- Set the proper data_type

        if value is None:
            data_type = 'FLOAT'
        else:
            data_type = socket.value_data_type(value)
        setattr(self, driving_param, data_type)
        
        # ----- Plug the value
        
        self.plug(socket_name, socket)
    """
