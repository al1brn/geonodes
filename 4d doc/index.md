...
> Compute 4D shapes Geometry Nodes scripted with **geopy**.

<p align="center">
    <img src="images/Hypercube.gif" width = "600px"/>
</p>

> Source code of this project can be found in `geopy.nodes.fourd.py` file.
...
The modifiers are build by calling **build4D** method of the **geopy** module:
...
> Moddifiers can be adder either manually or with **geopy** to create custom shapes.
...
``` python
    with geopy("Normalize 3-Basis", is_group=True, fake_user=True, prefix=g_maths) as tree:
