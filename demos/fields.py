...
def demo():
    ...
    with GeoNodes("Field", prefix=show_prefix):
        ...
        with Layout("Arrows:"):
            ...
            arrows_group.link_from(include=['Scale', 'Logarithm'], rename={'Color': 'Arrow Color'})
        ...
        with Layout("Arrows on lines of field"):
            ...
            lar_group.link_from(include=[], rename={'Logarithm': 'Lines Arrows Log', 'Color': 'Lines Arrows Color'})
    ...
    with GeoNodes("Visualize some fields"):
        ...
        source_node.link_from(include=['Geometry', 'Size', 'Density', 'Seed', 'Shape'])
